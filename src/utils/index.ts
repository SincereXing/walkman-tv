...
export const toNewMusicInfo = (oldMusicInfo: any): LX.Music.MusicInfo => {
  ...
  if (oldMusicInfo.source == 'local') {
    ...
    if (oldMusicInfo.mvId != null) meta.mvId = oldMusicInfo.mvId
    if (oldMusicInfo.mvVid) meta.mvVid = oldMusicInfo.mvVid
    if (oldMusicInfo.mvHash) meta.mvHash = oldMusicInfo.mvHash
...
export const toOldMusicInfo = (minfo: LX.Music.MusicInfo): any => {
  ...
  if (minfo.source == 'local') {
    ...
    if (minfo.meta.mvId != null) oInfo.mvId = minfo.meta.mvId
    if (minfo.meta.mvVid) oInfo.mvVid = minfo.meta.mvVid
    if (minfo.meta.mvHash) oInfo.mvHash = minfo.meta.mvHash
