...
export default () => {
  ...
  return (
    <ScrollView style={styles.container} keyboardShouldPersistTaps={'always'} horizontal={true} {...tvScrollParentProps}>
      {
        list.map(t => (
          <TvPressable style={styles.button} onPress={() => { handleTypeChange(t.id) }} key={t.id}>
