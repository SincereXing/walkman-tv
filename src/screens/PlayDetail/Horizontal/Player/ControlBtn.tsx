...
const PrevBtn = ({ size }: { size: number }) => {
  ...
  return (
    <TvPressable style={{ ...styles.cotrolBtn, width: size, height: size }} onPress={handlePlayPrev}>
...
const NextBtn = ({ size }: { size: number }) => {
  ...
  return (
    <TvPressable style={{ ...styles.cotrolBtn, width: size, height: size }} onPress={handlePlayNext}>
...
const TogglePlayBtn = ({ size }: { size: number }) => {
  ...
  return (
    <TvPressable style={{ ...styles.cotrolBtn, width: size, height: size }} onPress={togglePlay}>
