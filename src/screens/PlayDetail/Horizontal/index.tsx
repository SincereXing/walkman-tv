...
import TvPlayDetailLayout from './TvPlayDetailLayout'
...
export default memo(({ componentId }: { componentId: string }) => {
  ...
  if (IS_TV_APP) {
    /** 仅一层 PageContent（由 PlayDetail/index 包裹），避免双层背景/Fragment 导致 flex 高度为 0 */
    return <TvPlayDetailLayout componentId={componentId} />
  }
