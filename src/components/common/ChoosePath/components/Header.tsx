    ...
    <>
      <View style={{
        ...
        <View style={styles.actions}>
          <TvPressable style={styles.actionBtn} onPress={openStorage}>
            <Icon name="sd-card" color={theme['c-primary-font']} size={22} />
          </TvPressable>
          <TvPressable style={styles.actionBtn} onPress={handleShowNewFolderModal}>
            <Icon name="add_folder" color={theme['c-primary-font']} size={22} />
          </TvPressable>
          <TvPressable style={styles.actionBtn} onPress={refresh}>
