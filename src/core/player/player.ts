...
import { appendMusicToDefaultList } from '@/core/player/defaultListHistory'
import {
  clearTempPlayeList,
  removeTempPlayList,
...
const handleRestorePlay = async(restorePlayInfo: LX.Player.SavedPlayInfo) => {
  ...
  if (!playMusicInfo.isTempPlay && playMusicInfo.listId !== LIST_IDS.DEFAULT) void appendMusicToDefaultList(playMusicInfo.musicInfo)
